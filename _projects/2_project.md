...
<div class="caption">
    On the left, Geographical Visualization of the detected anomalies by neighborhood. The number of liters lost in anomalies, the percentage of anomalies or other socioeconomic factors can also be visualized. On the right, future consumption predictions with Prophet.
</div>
